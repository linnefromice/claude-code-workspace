...
| `documentation-maintainer.md` | intermediate | general | ドキュメント整合性管理 | - |
| `technical-architect.md` | intermediate | general | システム設計・アーキテクチャ | - |
| `qa-specialist.md` | intermediate | general | テスト戦略・品質保証 | - |
...
| `check.md` | beginner | general | 品質チェック一括実行 | - |
...
| `pr-learning.md` | advanced | general | マージ済みPRからルール・スキル更新提案 | learning |
...
| `common/task-completion.md` | beginner | general | タスク完了チェックリスト | - |
| `common/agent-teams.md` | intermediate | general | Agent Teams 自動起動ルール | - |
| `common/component-reuse.md` | beginner | general | コンポーネント共通化ルール | - |
...
| `create-goal/` | beginner | general | ゴール文書対話的作成 | - |
| `ship/` | beginner | general | 実装完了ワンコマンド出荷 | - |
...
| 日付 | 内容 |
|------|------|
| 2026-04-02 | v3.1: 9リポジトリ横断調査から Agents×3・Commands×2・Rules×3・Skills×2 を統合追加 |
