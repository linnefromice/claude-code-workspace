...
サブエージェントが作業を開始するまで必要なコンテキストがわからないマルチエージェントワークフローの「コンテキスト問題」を解決します。

## 起動条件

- サブエージェントのコンテキスト共有の最適化
- マルチエージェントワークフローの設計
- エージェント間のコンテキスト伝搬パターンの改善
- 限られたコンテキストウィンドウでのコードベース探索
- 段階的なコンテキスト精緻化パイプラインの構築
